...
initial_announcements = [
    {
        "id": "welcome-open-house",
        "title": "Feira de Clubes e Equipes",
        "message": "Passe no pátio central nesta semana para conhecer os clubes, tirar dúvidas com os professores e descobrir vagas abertas nas atividades do semestre.",
        "starts_on": None,
